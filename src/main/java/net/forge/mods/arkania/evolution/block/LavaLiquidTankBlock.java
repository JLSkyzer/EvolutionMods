...
public class LavaLiquidTankBlock extends EvolutionModElements.ModElement {
	@ObjectHolder("evolution:lava_liquid_tank")
	public static final Block block = null;
	public LavaLiquidTankBlock(EvolutionModElements instance) {
		super(instance, 92);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lava_liquid_tank");
		}
