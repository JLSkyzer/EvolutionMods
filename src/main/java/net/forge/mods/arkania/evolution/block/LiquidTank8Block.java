...
public class LiquidTank8Block extends EvolutionModElements.ModElement {
	@ObjectHolder("evolution:liquid_tank_8")
	public static final Block block = null;
	public LiquidTank8Block(EvolutionModElements instance) {
		super(instance, 87);
	}
