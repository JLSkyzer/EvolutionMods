...
public class LiquidtankBlock extends EvolutionModElements.ModElement {
	@ObjectHolder("evolution:liquidtank")
	public static final Block block = null;
	public LiquidtankBlock(EvolutionModElements instance) {
		super(instance, 79);
	}
