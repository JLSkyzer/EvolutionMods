...
public class OnyxOreBlockBlock extends EvolutionModElements.ModElement {
	@ObjectHolder("evolution:onyx_ore_block")
	public static final Block block = null;
	public OnyxOreBlockBlock(EvolutionModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("onyx_ore_block");
		}
