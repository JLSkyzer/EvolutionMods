...
public class LavaLiquidBlock8Block extends EvolutionModElements.ModElement {
	@ObjectHolder("evolution:lava_liquid_block_8")
	public static final Block block = null;
	public LavaLiquidBlock8Block(EvolutionModElements instance) {
		super(instance, 100);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lava_liquid_block_8");
		}
