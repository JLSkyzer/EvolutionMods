...
public class LavaLiquidTank6Block extends EvolutionModElements.ModElement {
	@ObjectHolder("evolution:lava_liquid_tank_6")
	public static final Block block = null;
	public LavaLiquidTank6Block(EvolutionModElements instance) {
		super(instance, 98);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lava_liquid_tank_6");
		}
