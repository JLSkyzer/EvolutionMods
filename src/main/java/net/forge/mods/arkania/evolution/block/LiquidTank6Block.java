...
public class LiquidTank6Block extends EvolutionModElements.ModElement {
	@ObjectHolder("evolution:liquid_tank_6")
	public static final Block block = null;
	public LiquidTank6Block(EvolutionModElements instance) {
		super(instance, 85);
	}
