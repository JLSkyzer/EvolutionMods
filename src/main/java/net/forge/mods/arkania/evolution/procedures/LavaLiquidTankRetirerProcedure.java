...
public class LavaLiquidTankRetirerProcedure extends EvolutionModElements.ModElement {
	public LavaLiquidTankRetirerProcedure(EvolutionModElements instance) {
		super(instance, 104);
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure LavaLiquidTankRetirer!");
			return;
		}
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure LavaLiquidTankRetirer!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure LavaLiquidTankRetirer!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure LavaLiquidTankRetirer!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure LavaLiquidTankRetirer!");
			return;
		}
		...
		if ((((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY)
			...
			if (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == LavaLiquidTank10Block.block.getDefaultState()
					.getBlock())) {
				{
				...
				{
					BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
					BlockState _bs = LavaLiquidTankBlock.block.getDefaultState();
					world.setBlockState(_bp, _bs, 3);
				}
				if (entity instanceof PlayerEntity)
					((PlayerEntity) entity).inventory.clearMatchingItems(p -> new ItemStack(Items.BUCKET, (int) (1)).getItem() == p.getItem(),
