...
public class LiquidTank10Block extends EvolutionModElements.ModElement {
	@ObjectHolder("evolution:liquid_tank_10")
	public static final Block block = null;
	public LiquidTank10Block(EvolutionModElements instance) {
		super(instance, 89);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("liquid_tank_10");
		}
