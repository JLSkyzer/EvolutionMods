...
public class OnyxPickaxeItem extends EvolutionModElements.ModElement {
	@ObjectHolder("evolution:onyx_pickaxe")
	public static final Item block = null;
	public OnyxPickaxeItem(EvolutionModElements instance) {
		super(instance, 7);
	}
