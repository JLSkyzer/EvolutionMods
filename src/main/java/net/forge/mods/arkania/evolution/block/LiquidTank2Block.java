...
public class LiquidTank2Block extends EvolutionModElements.ModElement {
	@ObjectHolder("evolution:liquid_tank_2")
	public static final Block block = null;
	public LiquidTank2Block(EvolutionModElements instance) {
		super(instance, 81);
	}
