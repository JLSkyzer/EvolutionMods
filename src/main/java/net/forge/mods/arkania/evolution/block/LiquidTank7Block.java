...
public class LiquidTank7Block extends EvolutionModElements.ModElement {
	@ObjectHolder("evolution:liquid_tank_7")
	public static final Block block = null;
	public LiquidTank7Block(EvolutionModElements instance) {
		super(instance, 86);
	}
