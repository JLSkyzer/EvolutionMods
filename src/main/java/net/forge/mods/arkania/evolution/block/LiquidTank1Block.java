...
public class LiquidTank1Block extends EvolutionModElements.ModElement {
	@ObjectHolder("evolution:liquid_tank_1")
	public static final Block block = null;
	public LiquidTank1Block(EvolutionModElements instance) {
		super(instance, 80);
	}
