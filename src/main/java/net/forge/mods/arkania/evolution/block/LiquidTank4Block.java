...
public class LiquidTank4Block extends EvolutionModElements.ModElement {
	@ObjectHolder("evolution:liquid_tank_4")
	public static final Block block = null;
	public LiquidTank4Block(EvolutionModElements instance) {
		super(instance, 83);
	}
