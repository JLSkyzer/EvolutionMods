...
public class LavaLiquidBlock1Block extends EvolutionModElements.ModElement {
	@ObjectHolder("evolution:lava_liquid_block_1")
	public static final Block block = null;
	public LavaLiquidBlock1Block(EvolutionModElements instance) {
		super(instance, 93);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lava_liquid_block_1");
		}
