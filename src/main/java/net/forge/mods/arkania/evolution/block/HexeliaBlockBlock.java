...
public class HexeliaBlockBlock extends EvolutionModElements.ModElement {
	@ObjectHolder("evolution:hexelia_block")
	public static final Block block = null;
	public HexeliaBlockBlock(EvolutionModElements instance) {
		super(instance, 45);
	}
