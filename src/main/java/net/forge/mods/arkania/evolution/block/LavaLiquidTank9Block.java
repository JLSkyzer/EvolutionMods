...
public class LavaLiquidTank9Block extends EvolutionModElements.ModElement {
	@ObjectHolder("evolution:lava_liquid_tank_9")
	public static final Block block = null;
	public LavaLiquidTank9Block(EvolutionModElements instance) {
		super(instance, 101);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lava_liquid_tank_9");
		}
