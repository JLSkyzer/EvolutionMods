...
public class LiquidTank3Block extends EvolutionModElements.ModElement {
	@ObjectHolder("evolution:liquid_tank_3")
	public static final Block block = null;
	public LiquidTank3Block(EvolutionModElements instance) {
		super(instance, 82);
	}
