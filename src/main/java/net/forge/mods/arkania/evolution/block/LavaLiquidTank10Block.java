...
public class LavaLiquidTank10Block extends EvolutionModElements.ModElement {
	@ObjectHolder("evolution:lava_liquid_tank_10")
	public static final Block block = null;
	public LavaLiquidTank10Block(EvolutionModElements instance) {
		super(instance, 102);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lava_liquid_tank_10");
		}
