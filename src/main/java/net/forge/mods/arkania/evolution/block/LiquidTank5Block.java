...
public class LiquidTank5Block extends EvolutionModElements.ModElement {
	@ObjectHolder("evolution:liquid_tank_5")
	public static final Block block = null;
	public LiquidTank5Block(EvolutionModElements instance) {
		super(instance, 84);
	}
