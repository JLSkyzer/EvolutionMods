...
public class LavaLiquidTank3Block extends EvolutionModElements.ModElement {
	@ObjectHolder("evolution:lava_liquid_tank_3")
	public static final Block block = null;
	public LavaLiquidTank3Block(EvolutionModElements instance) {
		super(instance, 95);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lava_liquid_tank_3");
		}
