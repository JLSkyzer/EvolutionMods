...
public class LavaLiquidTank5Block extends EvolutionModElements.ModElement {
	@ObjectHolder("evolution:lava_liquid_tank_5")
	public static final Block block = null;
	public LavaLiquidTank5Block(EvolutionModElements instance) {
		super(instance, 97);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lava_liquid_tank_5");
		}
