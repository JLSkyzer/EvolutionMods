...
public class LavaLiquidBlock4Block extends EvolutionModElements.ModElement {
	@ObjectHolder("evolution:lava_liquid_block_4")
	public static final Block block = null;
	public LavaLiquidBlock4Block(EvolutionModElements instance) {
		super(instance, 96);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lava_liquid_block_4");
		}
