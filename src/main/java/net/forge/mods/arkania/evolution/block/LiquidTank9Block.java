...
public class LiquidTank9Block extends EvolutionModElements.ModElement {
	@ObjectHolder("evolution:liquid_tank_9")
	public static final Block block = null;
	public LiquidTank9Block(EvolutionModElements instance) {
		super(instance, 88);
	}
