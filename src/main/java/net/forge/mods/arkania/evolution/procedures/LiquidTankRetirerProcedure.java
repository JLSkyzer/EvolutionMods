...
public class LiquidTankRetirerProcedure extends EvolutionModElements.ModElement {
	public LiquidTankRetirerProcedure(EvolutionModElements instance) {
		super(instance, 91);
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			System.err.println("Failed to load dependency entity for procedure LiquidTankRetirer!");
			return;
		}
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure LiquidTankRetirer!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure LiquidTankRetirer!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure LiquidTankRetirer!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure LiquidTankRetirer!");
			return;
		}
		...
		if ((((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY)
			...
			if (((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == LiquidTank10Block.block.getDefaultState().getBlock())) {
				{
