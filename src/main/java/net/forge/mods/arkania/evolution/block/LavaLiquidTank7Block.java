...
public class LavaLiquidTank7Block extends EvolutionModElements.ModElement {
	@ObjectHolder("evolution:lava_liquid_tank_7")
	public static final Block block = null;
	public LavaLiquidTank7Block(EvolutionModElements instance) {
		super(instance, 99);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lava_liquid_tank_7");
		}
