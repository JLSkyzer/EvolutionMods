...
public class DiggingMachineOnUpdateTickProcedure extends EvolutionModElements.ModElement {
	public DiggingMachineOnUpdateTickProcedure(EvolutionModElements instance) {
		super(instance, 68);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure DiggingMachineOnUpdateTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure DiggingMachineOnUpdateTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure DiggingMachineOnUpdateTick!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure DiggingMachineOnUpdateTick!");
			return;
		}
		...
		if (((new Object() {
		...
		}.getValue(new BlockPos((int) x, (int) y, (int) z), "drillFuel")) <= 0)) {
			if (((new Object() {
				...
				if (!world.getWorld().isRemote) {
					...
					if (_tileEntity != null)
						_tileEntity.getTileData().putDouble("drillFuel", ((new Object() {
							public double getValue(BlockPos pos, String tag) {
								TileEntity tileEntity = world.getTileEntity(pos);
								if (tileEntity != null)
									return tileEntity.getTileData().getDouble(tag);
						...
						}.getValue(new BlockPos((int) x, (int) y, (int) z), "drillFuel")) + 80));
				...
				if (!world.getWorld().isRemote) {
					...
					if (_tileEntity != null)
						...
						}.getValue(new BlockPos((int) x, (int) y, (int) z), "drillFuel")) + 20));
					world.getWorld().notifyBlockUpdate(_bp, _bs, _bs, 3);
				}
			} else if (((new Object() {
				public ItemStack getItemStack(BlockPos pos, int sltid) {
				...
				if (!world.getWorld().isRemote) {
					...
					if (_tileEntity != null)
						...
						}.getValue(new BlockPos((int) x, (int) y, (int) z), "drillFuel")) + 12));
					world.getWorld().notifyBlockUpdate(_bp, _bs, _bs, 3);
				}
			} else if (((new Object() {
				public ItemStack getItemStack(BlockPos pos, int sltid) {
				...
				if (!world.getWorld().isRemote) {
					...
					if (_tileEntity != null)
						...
						}.getValue(new BlockPos((int) x, (int) y, (int) z), "drillFuel")) + 8));
					world.getWorld().notifyBlockUpdate(_bp, _bs, _bs, 3);
				}
			} else if (((new Object() {
				public ItemStack getItemStack(BlockPos pos, int sltid) {
		...
		} else {
			{
				...
				DiggingMachineSkriptProcedure.executeProcedure($_dependencies);
			}
			if (!world.getWorld().isRemote) {
				BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
				TileEntity _tileEntity = world.getTileEntity(_bp);
				...
				if (_tileEntity != null)
					...
					}.getValue(new BlockPos((int) x, (int) y, (int) z), "drillFuel")) - 1));
				world.getWorld().notifyBlockUpdate(_bp, _bs, _bs, 3);
			}
			if (((new Object() {
				...
				world.setBlockState(new BlockPos((int) x, (int) y, (int) (z - 1)), DiggingMachineOnBlock.block.getDefaultState(), 3);
				try {
				...
				if (!world.getWorld().isRemote) {
					...
					if (_tileEntity != null)
						...
						}.getValue(new BlockPos((int) x, (int) y, (int) z), "drillFuel")));
					world.getWorld().notifyBlockUpdate(_bp, _bs, _bs, 3);
				}
				{
				...
				world.setBlockState(new BlockPos((int) (x - 1), (int) y, (int) z), DiggingMachineOnBlock.block.getDefaultState(), 3);
				try {
				...
				world.setBlockState(new BlockPos((int) x, (int) (y + 1), (int) z), DiggingMachineOnBlock.block.getDefaultState(), 3);
				try {
