...
public class LavaLiquidTank2Block extends EvolutionModElements.ModElement {
	@ObjectHolder("evolution:lava_liquid_tank_2")
	public static final Block block = null;
	public LavaLiquidTank2Block(EvolutionModElements instance) {
		super(instance, 94);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lava_liquid_tank_2");
		}
